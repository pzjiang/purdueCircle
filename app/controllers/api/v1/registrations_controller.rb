class Api::V1::RegistrationsController < Devise::RegistrationsController
  ...
  private
    ...
    def sign_up_params
      resource_params.permit(:email, :password, :password_confirmation, :first_name, :last_name, :username)
    end

    def account_update_params
      resource_params.permit(:email, :current_password, :first_name, :last_name, :username)
    end
